...
function createList(name) {
  return { id: Date.now().toString(), name: name, tasks: [] }; //return a unique identifier, explain why u chose Date.now for unique key!!!!!
}
...
function render() {
  ...
  lists.forEach((list) => {
    ...
    if (list.id === selectedTodoId()) {
      //check if selected list has an id
